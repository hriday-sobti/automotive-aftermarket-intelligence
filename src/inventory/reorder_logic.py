# Safety stock and reorder threshold calculations.
...
def compute_reorder_parameters(
    ...
    """Calculates Safety Stock (SS), Reorder Points (ROP), and Recommended Order Quantities (ROQ)

    for each distributor-SKU combination based on trailing 90-day demand variance.
    """
    ...
    # Trailing 90-day daily demand distribution
    ...
    # 3. Recommended Order Quantity: covers ROP deficit + 30 days of forward demand
